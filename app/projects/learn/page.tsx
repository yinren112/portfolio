  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12 sm:py-16">
      ...
      <Section title="起点：一个只有一个人用的工具">
        <p className="mb-4">
          最开始做的不是网站，是一个纯粹私人的命令行学习工具——给身边的人准备大模型和Agent方向的面试复习用的。这个工具本身就不简单：11个模块、44个知识点、108道练习题，有一套自己设计的间隔重复算法（答对后按1/3/7/14/30天逐步拉开复习间隔，答错就退一级），还有"连接题"专门考察知识能不能在不同场景之间迁移，不是死记硬背。
        </p>
        <p className="mb-4">
      ...
      <Section title="这门课讲了什么">
        ...
        <p>
          这些不是转述别人的科普文章，是把自己长期实际使用各类AI工具积累的理解，整理成了可以系统学习的课程。
        </p>
      </Section>
