    ...
    <div className="mx-auto max-w-3xl px-6 py-12 sm:py-16">
      ...
      <Section>
        <Callout title="这也是一个 Agent 原生设计的系统">
          <p className="mb-3">
            跟open-boss不一样的地方是：这里的"推理"环节没有用大模型，用的是规则引擎——但架构上走的是同一套
          ...
          <p>
            最能体现这一点的是账号库的设计：一个账号第一轮判断不出来是不是中介，第二轮如果在别的小区又发了一套"自己的房子"，新证据出现，判断会自动升级。账号库会持续观察、持续修正判断，从来不是分类一次就定型。这套
            <strong className="text-ink">感知-推理-行动-观察</strong>
            的闭环设计才是Agent的核心特征，跟用没用大模型关系不大。
          </p>
        </Callout>
      </Section>
